BUILD = build
MAKEFILE = Makefile
OUTPUT_FILENAME = Der_Albert_Nyanza_das_grosse_Becken_des_Nil_und_die_Erforschung_der_Nilquellen
TITLE_NAME = "Der Albert Nyanza das große Becken des Nil und die Erforschung der Nilquellen"
